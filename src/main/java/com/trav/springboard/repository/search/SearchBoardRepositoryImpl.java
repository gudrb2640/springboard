...
public class SearchBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchBoardRepository{
    ...
    @Override
    public Page<Object[]> searchPage(String type, String keyword, BoardCategory boardCategory, Pageable pageable) {
            ...
            for (String t : typeArr) {
                switch (t) {
                    ...
                    case "c":
                        ...
                        break;
                    case "w":
                        conditionBuilder.or(board.member.nickname.contains(keyword));
                        break;
                }
